...
print("")       
print("      _      _                _                _                      _                    ")
print("     /_\    | |_   ___ __  __| |_    __ _   __| |__   __  ___  _ __  | |_  _   _  _ __   ___ ")
print("    //_\\\   | __| / _ \\\ \/ /| __|  / _` | / _` |\ \ / / / _ \| '_ \ | __|| | | || '__| / _ \\")
print("   /  _  \  | |_ |  __/ >  < | |_  | (_| || (_| | \ V / |  __/| | | || |_ | |_| || |   |  __/")
print("  /__/ \__\  \__| \___|/_/\_\ \__|  \__,_| \__,_|  \_/   \___||_| |_| \__| \__,_||_|    \___|")
print("")
print("                                                                             By Jeff Leonard")
print("")
...
pushtext(f"Oh uh, I dropped them off in Galawyn before I came back. They were really hurt, so I made sure to get them there quick. Like any good boss would do.", speaker = "Frank", speed = 0.025)
...
pushtext([f"You're going to make {players.player.name} go all the way to Galawyn!?", f"The whole city has been on high-alert for the past couple weeks, {players.player.name} wouldn't even be able to get past the guards!"], speaker = "Peggy", speed = 0.03)
pushtext(f"Nonesense. All these demon sightings have the city on high alert for demons. Not kids.", speaker = "Frank", speed = 0.03)
pushtext(["...", f"{players.player.name}, there should be a key somewhere near the front door. It will open the gate leading to Galawyn.", 
"Be careful though sweetie. We have that gate for a reason. All sorts of wildlife are out there, a lot of them are pretty scary."], speaker = "Peggy", speed = 0.03)
rooms.r7.addnpc(npcs.tempend)
...
goblinencounter = combat.Combat(players.player, monsters.wanderinggoblin,bound = True)
